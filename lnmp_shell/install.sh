...
web=nginx
install_log=/home/website-info.log
...
./ftp/install_${vsftpd_dir}_own.sh
...
/usr/local/webserver/php/bin/php -f ./res/init_mysql.php
...
if echo $web|grep "nginx" > /dev/null;then
  echo 'export PATH=$PATH:/usr/local/webserver/mysql/bin:/usr/local/webserver/nginx/sbin:/usr/local/webserver/php/sbin:/usr/local/webserver/php/bin' >> /etc/profile
  export PATH=$PATH:/usr/local/webserver/mysql/bin:/usr/local/webserver/nginx/sbin:/usr/local/webserver/php/sbin:/usr/local/webserver/php/bin
fi
